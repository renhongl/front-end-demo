...
export default class MusicPlugin {
  ...
  init() {
    ...
    function Plugin($context, options) {
      ...
      this.$domProgressBar = this.$context.find(
    ...
    Plugin.prototype = {
      ...
      renderPlaylist: function() {
        ...
        $.each(self.settings.playlist, function(i, a) {
          ...
          template +=
            "<div class='jAudio--playlist-item' data-track='" + file + "'>";

          template +=
            "<div class='jAudio--playlist-thumb'><img src='" +
            thumb +
            "'></div>";
      ...
      animateProgressBarPosition: function() {
        var self = this,
          percentage =
            self.domAudio.currentTime * 100 / self.domAudio.duration + "%",
